...
from huggingface_sagemaker.huggingface_sagemaker_stack import HuggingfaceSagemakerRealtimeStack
...
HuggingfaceSagemakerRealtimeStack(app, "HuggingfaceSagemakerRealtimeStack",)
